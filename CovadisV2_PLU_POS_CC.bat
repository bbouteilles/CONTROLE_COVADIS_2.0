...
rem réalisé pour la DDT d'Isère, par Florian Luys - Stage de fin d'étude en Master 2 géomatique à l'Université de Montpellier 2 et 3. (mars/août 2014)
...
echo version du %version%
echo.
echo Effectué le %datcontrol1% par %auteur% >> %rappconf%
echo.>> %rappconf%
echo Géostandards COVADIS disponibles sur : >> %rappconf%
echo               http://archives.cnig.gouv.fr/Front/index.php?RID=120 >> %rappconf%
echo.>> %rappconf%
echo ATTENTION : Le présent contrôle n'intègre pas la vérification du contenu des >> %rappconf%
echo             données attributaires des tables, ni de la bonne reprise des objets>> %rappconf%
...
echo ---ERREUR -Le répertoire %insee%_%doc%_%datapro% n'a pas été créé. >> %rappconf%
goto Fin
: Exist
echo CONFORME -Le répertoire %insee%_%doc%_%datapro% existe. >> %rappconf%
move "%chem%" "%doss%"  
: Fin
echo. >> %rappconf%
echo. >> %rappconf%
...
echo ---ERREUR -Le répertoire Pieces_ecrites n'a pas été créé. >> %rappconf%
goto Fin1
: Exist1
echo CONFORME -Le répertoire Pieces_ecrites existe. >> %rappconf%
move "%chem1%" "%plu%" 
: Fin1
echo. >> %rappconf%
...
echo ---ERREUR -Le répertoire Donnees_geographiques n'a pas été créé. >> %rappconf%
goto Fin2
: Exist2
echo CONFORME -Le répertoire Donnees_geographiques existe. >> %rappconf%
move "%chem2%" "%plu%"
: Fin2
echo. >> %rappconf%
echo. >> %rappconf%
...
echo ---ERREUR -Le répertoire 1_Rapport_de_presentation n'a pas été créé. >> %rappconf%
goto Fin3
: Exist3
echo CONFORME -Le répertoire 1_Rapport_de_presentation existe. >> %rappconf%
move "%chem3%" "%pe%"
: Fin3
echo. >> %rappconf%
...
mkdir "%pe%\2_PADD"
echo ---ERREUR -Le répertoire 2_PADD n'a pas été créé. >> %rappconf%
goto Fin4
: Exist4
echo CONFORME -Le répertoire 2_PADD existe. >> %rappconf%
move "%chem4%" "%pe%"
: Fin4
echo. >> %rappconf%
...
echo ---ERREUR -Le répertoire 3_Reglement n'a pas été créé. >> %rappconf%
goto Fin5
: Exist5
echo CONFORME -Le répertoire 3_Reglement existe. >> %rappconf%
move "%chem5%" "%pe%"
: Fin5
echo. >> %rappconf%
...
mkdir "%pe%\4_Annexes"
echo ---ERREUR -Le répertoire 4_Annexes n'a pas été créé. >> %rappconf%
goto Fin6
: Exist6
echo CONFORME -Le répertoire 4_Annexes existe. >> %rappconf%
move "%chem6%" "%pe%"
: Fin6
echo. >> %rappconf%
goto Ordoss
...
mkdir "%pe%\2_Annexes"
echo ---ERREUR -Le répertoire 2_Annexes n'a pas été créé. >> %rappconf%
goto Fin8
: Exist6bis
echo CONFORME -Le répertoire 2_Annexes existe. >> %rappconf%
move "%chem6bis%" "%pe%"
goto Fin8
...
echo ---ERREUR -Le répertoire 5_Orientations_amenagement n'a pas été créé. >> %rappconf%
goto Fin7
: Exist7
echo CONFORME -Le répertoire 5_Orientations_amenagement existe. >> %rappconf%
move "%chem7%" "%pe%"
: Fin7
echo. >> %rappconf%
...
echo Optionnel -Le répertoire 6_Documents_graphiques n'a pas été créé. >> %rappconf%
goto Fin8
: Exist8
echo CONFORME -Le répertoire 6_Documents_graphiques existe. >> %rappconf%
move "%chem8%" "%pe%"
: Fin8
echo. >> %rappconf%
echo. >> %rappconf%
...
if /I "%choix%"=="1" (
echo ---ATTENTION: Le controle des données géographiques n'a pas été effectué.>> %rappconf%
echo. >> %rappconf%
goto DebutControlePDF
)
if /I "%choix%"=="2" (
echo ---ATTENTION: Le controle des pdf n'a pas été effectué.>> %rappconf%
echo. >> %rappconf%
...
echo ***ERREURpdf -Aucun pdf n'a été livrés. >> %rappconf%
...
: RaOK
echo CONFORME -Le pdf %insee%_rapport_%datapro% a bien été livré.>> %rappconf%
echo. >> %rappconf%
goto OpenRa
rem ===============================================================================================================================================================
...
IF "%concat1%"=="o" (
echo ---ERREURpdf -Le pdf est à concaténer et à renommer : %insee%_rapport_%datapro%.>> %rappconf%
echo.>> %rappconf%
goto FinRa
)
rem test nommage :
...
echo ---ERREURpdf -Le pdf est à renommer : %insee%_rapport_%datapro%.>> %rappconf%
echo. >> %rappconf%
goto FinRa
) else (
echo ---ERREURpdf -Le pdf %insee%_rapport_%datapro% n'a pas été livré.>> %rappconf%
echo. >> %rappconf%
goto FinRa
)
rem ===============================================================================================================================================================
...
:index1
echo.>> %rappconf% 
echo          ---- Le pdf du rapport de presentation n'est pas indexé. >> %rappconf% 
: FinRa
cls
echo Controle des PDF...
rem ===============================================================================================================================================================
...
rem si oui conforme sinon test concatenage et nommage:
: PaOK
echo CONFORME -Le pdf %insee%_padd_%datapro% a bien été livré.>> %rappconf%
echo. >> %rappconf%
goto OpenPa
rem ===============================================================================================================================================================
...
rem question si oui il faut les concatener message dans rapport et passage au suivant sinon test nommage:
IF "%concat2%"=="o" (
echo ---ERREURpdf -Le pdf est à concaténer et à renommer : %insee%_padd_%datapro%.>> %rappconf%
echo.>> %rappconf%
goto FinPa
)
rem test nommage :
...
echo ---ERREURpdf -Le pdf est à renommer : %insee%_padd_%datapro%.>> %rappconf%
echo. >> %rappconf%
goto FinPa
) else (
echo ---ERREURpdf -Le pdf %insee%_padd_%datapro% n'a pas été livré.>> %rappconf%
echo. >> %rappconf%
goto FinPa
)
rem ===============================================================================================================================================================
...
:index2
echo.>> %rappconf% 
echo          ---- Le pdf du PADD n'est pas indexé. >> %rappconf% 
: FinPa
cls
echo Controle des PDF...
rem ===============================================================================================================================================================
...
rem si oui conforme sinon test concatenage et nommage:
: ReOK
echo CONFORME -Le pdf %insee%_reglement_%datapro% a bien été livré.>> %rappconf%
echo. >> %rappconf%
goto OpenRe
rem ===============================================================================================================================================================
...
rem question si oui il faut les concatener message dans rapport et passage au suivant sinon test nommage:
IF "%concat3%"=="o" (
echo ---ERREURpdf -Le pdf est à concaténer et à renommer : %insee%_reglement_%datapro%.>> %rappconf%
echo.>> %rappconf%
goto FinRe
)
rem test nommage :
...
echo ---ERREURpdf -Le pdf est à renommer : %insee%_reglement_%datapro%.>> %rappconf%
echo. >> %rappconf%
goto FinRe
) else (
echo ---ERREURpdf -Le pdf %insee%_reglement_%datapro% n'a pas été livré.>> %rappconf%
echo. >> %rappconf%
goto FinRe
)
rem ===============================================================================================================================================================
...
:index3
echo.>> %rappconf% 
echo          ---ERREURpdf- Le pdf du reglement doit être indexé. >> %rappconf% 
: FinRe
cls
echo Controle des PDF...
rem ===============================================================================================================================================================
...
rem si oui conforme sinon test concatenage et nommage:
: AnOK
echo CONFORME -Le pdf %insee%_annexes_%datapro% a bien été livré.>> %rappconf%
echo. >> %rappconf%
goto OpenAn
rem ===============================================================================================================================================================
...
rem question si oui il faut les concatener message dans rapport et passage au suivant sinon test nommage:
IF "%concat4%"=="o" (
echo ---ERREURpdf -Le pdf est à concaténer et à renommer : %insee%_annexes_%datapro%.>> %rappconf%
echo.>> %rappconf%
goto FinAn
)
rem test nommage :
...
echo ---ERREURpdf -Le pdf est à renommer : %insee%_annexes_%datapro%.>> %rappconf%
echo. >> %rappconf%
goto FinAn
) else (
echo ---ERREURpdf -Le pdf %insee%_annexes_%datapro% n'a pas été livré.>> %rappconf%
echo. >> %rappconf%
goto FinAn
)
rem ===============================================================================================================================================================
...
:index4
echo.>> %rappconf% 
echo          ---ERREURpdf- Le pdf des annexes doit être indexé. >> %rappconf% 
: FinAn 
cls
echo Controle des PDF...
goto PDFOR
...
rem si oui conforme sinon test concatenage et nommage:
: OrOK
echo CONFORME -Le pdf %insee%_orientations_%datapro% a bien été livré.>> %rappconf%
echo. >> %rappconf%
goto OpenOr
rem ===============================================================================================================================================================
...
rem question si oui il faut les concatener message dans rapport et passage au suivant sinon test nommage:
IF "%concat5%"=="o" (
echo ---ERREURpdf -Le pdf est à concaténer et à renommer : %insee%_orientations_%datapro%.>> %rappconf%
echo.>> %rappconf%
goto FinOr
)
rem test nommage :
...
echo ---ERREURpdf -Le pdf est à renommer : %insee%_orientations_%datapro%.>> %rappconf%
echo. >> %rappconf%
goto FinOr
) else (
echo ---ERREURpdf -Le pdf %insee%_orientations_%datapro% n'a pas été livré.>> %rappconf%
echo. >> %rappconf%
goto FinOr
)
rem ===============================================================================================================================================================
...
:index5
echo.>> %rappconf% 
echo          ---- Le pdf des orientations d'amenagement n'est pas indexé. >> %rappconf% 
: FinOr 
cls
echo Controle des PDF...
rem ===============================================================================================================================================================
...
rem si oui conforme sinon test concatenage et nommage:
: DocGOK
echo CONFORME -Le pdf %insee%_docgraphiques_%datapro% a bien été livré.>> %rappconf%
echo. >> %rappconf%
goto OpenDocG
rem ===============================================================================================================================================================
...
rem question si oui il faut les concatener message dans rapport et passage au suivant sinon test nommage:
IF "%concat6%"=="o" (
echo ---ERREURpdf -Le pdf est à concaténer et à renommer : %insee%_docgraphiques_%datapro%.>> %rappconf%
echo.>> %rappconf%
goto FinDocG
)
rem test nommage :
...
echo ---ERREURpdf -Le pdf est à renommer : %insee%_docgraphiques_%datapro%.>> %rappconf%
echo. >> %rappconf%
goto FinDocG
) else (
echo ----Le pdf %insee%_docgraphiques_%datapro% n'a pas été livré.>> %rappconf%
echo. >> %rappconf%
goto FinDocG
)
rem ===============================================================================================================================================================
...
:index6
echo.>> %rappconf% 
echo          ---- Le pdf des documents graphiques n'est pas indexé. >> %rappconf% 
: FinDocG
cls
echo Controle des PDF...
rem ===============================================================================================================================================================
...
echo Controle des donnees geographiques...
 ...
 echo ***ERREURdg -Aucune couche n'a été livrée. >> %rappconf%
 echo.
goto BilanDG
...
:ZU1
	echo CONFORME -La couche testée est une version CORRIGEE (en interne).>> %rappconf%
	echo. >> %rappconf%
	goto OpenZU 
:ZU2
...
:ZU7
	echo CONFORME -La couche N_ZONE_URBA_%insee%_038 a bien été livrée.>> %rappconf%
	echo. >> %rappconf%
	goto OpenZU
:ZU8
...
:ZU9
	echo ---ERREURdg -La couche est à renommer : N_ZONE_URBA_%insee%_038.>> %rappconf%
	echo. >> %rappconf%
	goto OpenZU 
:ZU10
...
:ZU17
	...
	goto OpenZU 
:NOZU
	echo ----La couche N_ZONE_URBA_%insee%_038 n'a pas été livrée.>> %rappconf%
	echo. >> %rappconf%
	echo. >> %rappconf%
	goto PSURF
...
rem notification des remarques PROJECTION et ENCODAGE:
 ...
 IF "%PROJ1%"=="n" ( 
 echo -----**ERREURdg-PROJECTION NON-CONFORME : définir en RGF Lambert 93, EPSG : 2154.  >> %rappconf% 
 echo.  >> %rappconf%
 )
 set /p ENCO1="ENCODAGE UTF 8 ? (o/n) : " 
 IF "%ENCO1%"=="n" (
 echo -----**ERREURdg-L'encodage en UTF-8 est fortement conseillé.  >> %rappconf% 
 echo.  >> %rappconf%
 )
...
echo -ATTENTION : Le champ "ID_MAP (integer)" a été ajouté au standard par le MEDDE. >> %rappconf% 
echo              Son abscence n'est pas un critère de non-conformité. >> %rappconf% 
echo. >> %rappconf% 
...
:PS7
	echo CONFORME -La couche N_PRESCRIPTION_SURF_%insee%_038 a bien été livrée.>> %rappconf%
	echo. >> %rappconf%
	goto OpenPS
:PS8
...
:PS9
	echo ---ERREURdg -La couche est à renommer : N_PRESCRIPTION_SURF_%insee%_038.>> %rappconf%
	echo. >> %rappconf%
	goto OpenPS 
:PS10
...
:PS17
	...
	goto OpenPS 
:NOPS
	echo ----La couche N_PRESCRIPTION_SURF_%insee%_038 n'a pas été livrée.>> %rappconf%
	echo. >> %rappconf%
	echo. >> %rappconf%
	goto PLIN
...
:PL7
	echo CONFORME -La couche N_PRESCRIPTION_LIN_%insee%_038 a bien été livrée.>> %rappconf%
	echo. >> %rappconf%
	goto OpenPL
:PL8
...
:PL9
	echo ---ERREURdg -La couche est à renommer : N_PRESCRIPTION_LIN_%insee%_038.>> %rappconf%
	echo. >> %rappconf%
	goto OpenPL 
:PL10
...
:PL17
	...
	goto OpenPL 
:NOPL
	echo ----La couche N_PRESCRIPTION_LIN_%insee%_038 n'a pas été livrée.>> %rappconf%
	echo. >> %rappconf%
	echo. >> %rappconf%
	goto PPCT
...
:PP7
	echo CONFORME -La couche N_PRESCRIPTION_PCT_%insee%_038 a bien été livrée.>> %rappconf%
	echo. >> %rappconf%
	goto OpenPP
:PP8
...
:PP9
	echo ---ERREURdg -La couche est à renommer : N_PRESCRIPTION_PCT_%insee%_038.>> %rappconf%
	echo. >> %rappconf%
	goto OpenPP 
:PP10
...
:PP17
	...
	goto OpenPP 
:NOPP
	echo ----La couche N_PRESCRIPTION_PCT_%insee%_038 n'a pas été livrée.>> %rappconf%
	echo. >> %rappconf%
	echo. >> %rappconf%
	goto ISURF
...
:IS7
	echo CONFORME -La couche N_INFO_SURF_%insee%_038 a bien été livrée.>> %rappconf%
	echo. >> %rappconf%
	goto OpenIS
:IS8
...
:IS9
	echo ---ERREURdg -La couche est à renommer : N_INFO_SURF_%insee%_038.>> %rappconf%
	echo. >> %rappconf%
	goto OpenIS 
:IS10
...
:IS17
	...
	goto OpenIS 
:NOIS
	echo ----La couche N_INFO_SURF_%insee%_038 n'a pas été livrée.>> %rappconf%
	echo. >> %rappconf%
	echo. >> %rappconf%
	goto ILIN
...
rem notification des remarques PROJECTION et ENCODAGE:
 ...
 IF "%PROJ5%"=="n" ( 
 echo -----**ERREURdg-PROJECTION NON-CONFORME : définir en RGF Lambert 95, EPSG : 2154.  >> %rappconf% 
 echo.  >> %rappconf%
 )
...
:IL7
	echo CONFORME -La couche N_INFO_LIN_%insee%_038 a bien été livrée.>> %rappconf%
	echo. >> %rappconf%
	goto OpenIL
:IL8
...
:IL9
	echo ---ERREURdg -La couche est à renommer : N_INFO_LIN_%insee%_038.>> %rappconf%
	echo. >> %rappconf%
	goto OpenIL 
:IL10
...
:IL17
	...
	goto OpenIL 
:NOIL
	echo ----La couche N_INFO_LIN_%insee%_038 n'a pas été livrée.>> %rappconf%
	echo. >> %rappconf%
	echo. >> %rappconf%
	goto IPCT
...
:IP7
	echo CONFORME -La couche N_INFO_PCT_%insee%_038 a bien été livrée.>> %rappconf%
	echo. >> %rappconf%
	goto OpenIP
:IP8
...
:IP9
	echo ---ERREURdg -La couche est à renommer : N_INFO_PCT_%insee%_038.>> %rappconf%
	echo. >> %rappconf%
	goto OpenIP 
:IP10
...
:IP17
	...
	goto OpenIP 
:NOIP
	echo ----La couche N_INFO_PCT_%insee%_038 n'a pas été livrée.>> %rappconf%
	echo. >> %rappconf%
	echo. >> %rappconf%
	goto HSURF
...
:SCC7
	echo CONFORME -La couche N_SECTEUR_CC_%insee%_038 a bien été livrée.>> %rappconf%
	echo. >> %rappconf%
	goto OpenSCC
:SCC8
...
:SCC9
	echo ---ERREURdg -La couche est à renommer : N_SECTEUR_CC_%insee%_038.>> %rappconf%
	echo. >> %rappconf%
	goto OpenSCC 
:SCC10
...
:SCC17
	...
	goto OpenSCC 
:NOSCC
	echo ----La couche N_SECTEUR_CC_%insee%_038 n'a pas été livrée.>> %rappconf%
	echo. >> %rappconf%
	echo. >> %rappconf%
	goto ISURFbis
...
:HS7
	echo CONFORME -La couche N_HABILLAGE_SURF_%insee%_038 a bien été livrée.>> %rappconf%
	echo. >> %rappconf%
	goto OpenHS
:HS8
...
:HS9
	echo ---ERREURdg -La couche est à renommer : N_HABILLAGE_SURF_%insee%_038.>> %rappconf%
	echo. >> %rappconf%
	goto OpenHS 
:HS10
...
:HS17
	...
	goto OpenHS 
:NOHS
	echo ----La couche N_HABILLAGE_SURF_%insee%_038 n'a pas été livrée.>> %rappconf%
	echo. >> %rappconf%
	echo. >> %rappconf%
	goto HLIN
...
:HL7
	echo CONFORME -La couche N_HABILLAGE_LIN_%insee%_038 a bien été livrée.>> %rappconf%
	echo. >> %rappconf%
	goto OpenHL
:HL8
...
:HL9
	echo ---ERREURdg -La couche est à renommer : N_HABILLAGE_LIN_%insee%_038.>> %rappconf%
	echo. >> %rappconf%
	goto OpenHL 
:HL10
...
:HL17
	...
	goto OpenHL 
:NOHL
	echo ----La couche N_HABILLAGE_LIN_%insee%_038 n'a pas été livrée.>> %rappconf%
	echo. >> %rappconf%
	echo. >> %rappconf%
	goto HPCT
...
:HP7
	echo CONFORME -La couche N_HABILLAGE_PCT_%insee%_038 a bien été livrée.>> %rappconf%
	echo. >> %rappconf%
	goto OpenHP
:HP8
...
:HP9
	echo ---ERREURdg -La couche est à renommer : N_HABILLAGE_PCT_%insee%_038.>> %rappconf%
	echo. >> %rappconf%
	goto OpenHP 
:HP10
...
:HP17
	...
	goto OpenHP 
:NOHP
	echo ----La couche N_HABILLAGE_PCT_%insee%_038 n'a pas été livrée.>> %rappconf%
	echo. >> %rappconf%
	echo. >> %rappconf%
	goto HTXT
...
:HT7
	echo CONFORME -La couche N_HABILLAGE_TXT_%insee%_038 a bien été livrée.>> %rappconf%
	echo. >> %rappconf%
	goto OpenHT
:HT8
...
:HT9
	echo ---ERREURdg -La couche est à renommer : N_HABILLAGE_TXT_%insee%_038.>> %rappconf%
	echo. >> %rappconf%
	goto OpenHT 
:HT10
...
:HT17
	...
	goto OpenHT 
:NOHT
	echo ----La couche N_HABILLAGE_TXT_%insee%_038 n'a pas été livrée.>> %rappconf%
	echo. >> %rappconf%
	echo. >> %rappconf%
	goto DOCU
...
:DOCU7
	echo CONFORME -La couche N_DOCUMENT_URBA_038 a bien été livrée.>> %rappconf%
	echo. >> %rappconf%
	goto OpenDOCU
:DOCU8
...
:DOCU9
	echo ---ERREURdg -La couche est à renommer : N_DOCUMENT_URBA_038.>> %rappconf%
	echo. >> %rappconf%
	goto OpenDOCU 
:DOCU10
...
:DOCU17
	...
	goto OpenDOCU 
:NODOCU
	echo ----La couche N_DOCUMENT_URBA_038 n'a pas été livrée.>> %rappconf%
	echo. >> %rappconf%
	echo. >> %rappconf%
	goto FinDOCU
